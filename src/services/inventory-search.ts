...
class MarketCheckService {
  ...
  private getDemoListings(filters: InventorySearchFilters): InventoryListing[] {
    ...
    // ⚡ Bolt Performance Optimization: Combine filters into a single pass
    // Prevent multiple chained O(N) traversals and redundant intermediate array allocations.
    // Expected impact: Faster search, lower memory footprint.
