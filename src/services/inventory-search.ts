...
class MarketCheckService {
  ...
  private getDemoListings(filters: InventorySearchFilters): InventoryListing[] {
    ...
    // Combined multiple filter conditions into a single pass to avoid redundant O(N) traversals
    // and intermediate memory allocations. Loop-invariant strings are normalized outside.
